...
#ifndef MYSAMPLE_SWIFT_H
#define MYSAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mysample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8mysample11AppDelegate")
...
SWIFT_CLASS("_TtC8mysample17MainFlutterWindow")
